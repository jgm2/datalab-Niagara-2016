 ...
 * The FrameDetectorX
 */
public class FrameDetectorX_WithFragments
{ 
...
public FrameDetectorX_WithFragments()
  {
    frameTuples = new Vector<FrameTupleX>();
    //frames = new Vector<FrameOutputX>();
  }
  
  public FrameDetectorX_WithFragments(FrameTupleX fTupleX, int frameSize)
  {
	  ...
	  Vector<FrameOutputX> framesToOutput = new Vector<FrameOutputX>();
	    ...
	    if(!currentFrameClosed){
    		if (currentFrameCount >= frameSize){
    			...
    			latestPunctTime = currentFrameStartTime-1;
    		}
