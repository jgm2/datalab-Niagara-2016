...
import niagara.logical.WindowLongAggregate;
...
/**
 * Jim Miller (JGM), 06/18/2013
 * PhysicalWindowLongAggregate, implemented for the 2013 DEBS Heatmap challenge.
 * 
 * Based off of PhysicalWindowAggregate.
 */
...
public abstract class PhysicalWindowLongAggregate extends PhysicalWindowGroup {
	...
	protected abstract PhysicalWindowLongAggregate getInstance();
	...
	protected void localInitFrom(LogicalOp logicalOperator) {
		...
		aggrAttr = ((WindowLongAggregate) logicalOperator).getAggrAttr();
		widName = ((WindowLongAggregate) logicalOperator).getWid();
	}
	...
	protected PhysicalWindowGroup localCopy() {
		PhysicalWindowLongAggregate op = getInstance();
	...
	protected boolean localEquals(Object o) {
		return aggrAttr.equals(((PhysicalWindowLongAggregate) o).aggrAttr)
				&& widName.equals(((PhysicalWindowLongAggregate) o).widName); // &&
