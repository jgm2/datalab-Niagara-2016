    ...
    try
    {
      ...
      {    
            ...
            else
            {
              ...
              {            
                ...
                case XML:
                  ...
                  break;
                case Double:
                    pTuple.appendAttribute(new DoubleAttr(reader.get(i)));
                    //System.out.print(", " + reader.get(i));
                    break;
                default:
          ...
          for (int i = 0; i<specNumAttrs; i++)
          {
            ...
            {            
              ...
              case XML:
                ...
                break;
              case Double:
                  outputTuple.appendAttribute(new DoubleAttr(reader.get(i)));
                  //System.out.print(", " + reader.get(i));
                  break;
              default:
                throw new PEException("Invalid type " + spec.getAttrType(i));  
        ...
        /*//sleep for time on sleep attribute
			...
			String value = ((BaseAttr) outputTuple.getAttribute(2)).attrVal().toString();
    ...
    for (int i = 1; i<= numAttrs; i++)
    {
      switch (spec.getAttrType(i - 1))
      {
        ...
        case XML:
          ...
          break;
        case Double:
            outputTuple.appendAttribute(new DoubleAttr(scanner.next()));
            break;
        default:
          throw new PEException("Invalid type " + spec.getAttrType(i));            
      }
