 ...
 * 
 */
public class PhysicalFrameX extends PhysicalOperator
{
  ...
  public PhysicalFrameX()
  {
    this.setBlockingSourceStreams(PhysicalFrameX.blockingSourceStreams);
  }
    ...
    if(!pGroupBy.equals("*"))
    {
      ...
      if (framesHashMap.containsKey(groupByAsInt))
      {
        ...
        if(framesToOutputX != null)
        {
          ...
          } else if(-1!=punctuatedUpToTime){
        	  System.out.println("Punct,"+punctuatedUpToTime);
          }
        }
      }
  ...
  public Op opCopy()
  {
    final PhysicalFrameX frame = new PhysicalFrameX();
  ...
  {
    if ((other == null) || !(other instanceof PhysicalFrameX))
    {
      return false;
    }
    if (other.getClass() != PhysicalFrameX.class)
    {
      return other.equals(this);
    }
    final PhysicalFrameX f = (PhysicalFrameX) other;
  ...
  public void streamClosed(int streamId) throws ShutdownException {
      ...
      {       
        ...
        if(null != framesToOutputX)
        {
            ...
            // Pass on punctuation.
        	outputPunctuation(streamId, punctuatedUpToTime);
        	 System.out.println(punctuatedUpToTime+","+framesToOutputX.endTime);
          } //if buffer is not empty, then last few tuples not in frame
        	else {
        	  framecount++;
          }
        }
